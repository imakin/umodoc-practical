  ...
  webPages: [
    ...
    },
    {
      ...
      transformURL(url) {
        ...
        return videoId
          ? `https://v.qq.com/iframe/player.html?vid=${videoId}`
          : ''
      },
    },
  ],
